...
public class JetService implements ManagedService, MembershipAwareService, LiveOperationsTracker {
    ...
    public void init(NodeEngine engine, Properties hzProperties) {
        ...
        this.jetConfig = config.getJetConfig();
        jetInstance = new JetInstanceImpl((HazelcastInstanceImpl) engine.getHazelcastInstance(), jetConfig);
        ...
        if (parseBoolean(config.getProperties().getProperty(JET_SHUTDOWNHOOK_ENABLED.getName()))) {
