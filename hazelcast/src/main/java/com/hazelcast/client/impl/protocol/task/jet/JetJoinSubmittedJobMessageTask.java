...
import com.hazelcast.client.impl.protocol.codec.JetJoinSubmittedJobCodec.RequestParameters;
import com.hazelcast.jet.impl.operation.JoinSubmittedJobOperation;
import com.hazelcast.spi.impl.operationservice.Operation;

public class JetJoinSubmittedJobMessageTask
        extends AbstractJetMessageTask<RequestParameters, Void> {
    public JetJoinSubmittedJobMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
