...
import com.hazelcast.client.impl.protocol.codec.JetExistsDistributedObjectCodec.RequestParameters;
import com.hazelcast.jet.impl.util.ImdgUtil;
import com.hazelcast.spi.impl.operationservice.Operation;

public class JetExistsDistributedObjectMessageTask
        extends AbstractJetMessageTask<RequestParameters, Boolean> {
