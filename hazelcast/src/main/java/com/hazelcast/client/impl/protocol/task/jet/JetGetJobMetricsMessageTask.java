...
import com.hazelcast.client.impl.protocol.codec.JetGetJobMetricsCodec.RequestParameters;
import com.hazelcast.jet.impl.operation.GetJobMetricsOperation;
import com.hazelcast.spi.impl.operationservice.Operation;

public class JetGetJobMetricsMessageTask
        extends AbstractJetMessageTask<RequestParameters, Data> {

    public JetGetJobMetricsMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
