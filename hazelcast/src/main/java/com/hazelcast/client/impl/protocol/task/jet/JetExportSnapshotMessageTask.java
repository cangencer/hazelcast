...
import com.hazelcast.client.impl.protocol.codec.JetExportSnapshotCodec.RequestParameters;
import com.hazelcast.spi.impl.operationservice.Operation;

public class JetExportSnapshotMessageTask extends AbstractJetMessageTask<RequestParameters, Void>
        implements BlockingMessageTask {

    public JetExportSnapshotMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
