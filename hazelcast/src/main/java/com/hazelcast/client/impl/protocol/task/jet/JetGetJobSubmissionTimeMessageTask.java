...
import com.hazelcast.client.impl.protocol.codec.JetGetJobSubmissionTimeCodec.RequestParameters;
...
public class JetGetJobSubmissionTimeMessageTask
        extends AbstractJetMessageTask<RequestParameters, Long> {

    public JetGetJobSubmissionTimeMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
