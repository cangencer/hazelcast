...
import com.hazelcast.client.impl.protocol.codec.JetGetJobIdsCodec.RequestParameters;
import com.hazelcast.jet.impl.operation.GetJobIdsOperation;
import com.hazelcast.spi.impl.operationservice.Operation;

import java.util.List;

public class JetGetJobIdsMessageTask extends AbstractJetMessageTask<RequestParameters, List<Long>> {
