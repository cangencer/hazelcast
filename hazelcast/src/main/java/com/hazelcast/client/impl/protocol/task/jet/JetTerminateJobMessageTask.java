...
import com.hazelcast.client.impl.protocol.codec.JetTerminateJobCodec.RequestParameters;
import com.hazelcast.jet.impl.operation.TerminateJobOperation;
import com.hazelcast.spi.impl.operationservice.Operation;

public class JetTerminateJobMessageTask extends AbstractJetMessageTask<RequestParameters, Void> {

    public JetTerminateJobMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
