...
import com.hazelcast.client.impl.protocol.codec.JetGetJobIdsByNameCodec.RequestParameters;
...
public class JetGetJobIdsByNameMessageTask
        extends AbstractJetMessageTask<RequestParameters, List<Long>> {

    public JetGetJobIdsByNameMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
